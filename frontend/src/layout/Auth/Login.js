...
const Login = () => {
  ...
  const [showModal1_2, setshowModal1_2] = useState(false);
      ...
      await dispatch(SignIn(req))
        ...
        .then((response) => {
          ...
          if (response.status) {
            ...
            console.log("response", response);
            if (response.msg == "your service is terminated please contact to admin") {
    ...
    <div class="vh-100">
      ...
      {showModal11 ? (
        <>
          <Modal
            isOpen={showModal11}
            handleClose={() => setshowModal11(false)}
            backdrop="static"
            size="xx"
            title="Upgrage Your Plan"
            btn_2={true}
            btn_name="CLOSE"
            btn_name_2="Purchase"
            Submit_Function={close_modal}
            Submit_Function_2={fun}
          >
            {!getOtpStatus ? (
              <p>
                <b>your service is terminated please contact to admin.</b>
              </p>
            ) : (
              ""
            )}
      ...
      <Modal
        ...
        hideBtn={true}
        handleClose={() => setshowModal1_2(false)}
      >
