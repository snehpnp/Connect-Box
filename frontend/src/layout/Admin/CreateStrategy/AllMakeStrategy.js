        ...
        },
        {
            ...
            formatter: (cell, row) => (
                <div>
                    ...
                    <Link to={user_role =="ADMIN" ?`/admin/MakeStrategy/edit/${row._id}`: user_role=="SUBADMIN" ? `/subadmin/MakeStrategy/edit/${row._id}`: ""} data-toggle="tooltip" data-placement="top" title="Edit">
