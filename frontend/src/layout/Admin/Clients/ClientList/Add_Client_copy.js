  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      const req = {
        ...
        "count_strategy_select":values.count_strategy_select
      }
...
console.log("req",req)
  ...
  const fields = [
    ...
    { name: 'count_strategy_select', label: 'Strategy Selection Count', type: 'text', label_size: 12, col_size: 6, disable: false },
  ];
