...
const AllLicence = () => {
  ...
  const columns = [
    ...
    {
      dataField: "Role", // Use the correct field name
      text: "Role",
      formatter: (cell, row, rowIndex) => (
        <div
          style={{
            ...
            <div className="row flex">
              ...
              {dashboard_filter !== undefined ? "" : <>
                ...
                <div className="row mb-5">
                  <div className="col-12 col-md-12 col-lg-2 mx-auto border-right ">
                    <h6 >Start Date</h6>
                  ...
                  <div className="col-12 col-md-12 col-lg-2 mx-auto  ">
