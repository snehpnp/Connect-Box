...
// Get Margin data
export async function Get_user_margin(data) {
    try {
        const res = await axios.post(`${Config.base_url}get/livemargin/data`, data, {
            // headers: header(token),
            data: {},
        })
        // console.log("res", res);
...
export async function GetLiveMarketData(data, token) {
    try {
        const res = await axios.post(`${Config.base_url}get/live/data`, data, {
            // headers: header(token),
            data: {},
        })
        return await res?.data;
...
// Get Order Data
export async function Get_order_data(data) {
    try {
        const res = await axios.post(`${Config.base_url}get/live/order`, data, {
            // headers: header(token),
            data: {},
        })
        // console.log("res", res);
