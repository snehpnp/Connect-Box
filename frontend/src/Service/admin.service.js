...
// PAYMENT GATEWAYKEY KEY
export async function PAYMENT_GATEWAY_KEY(data, token) {
    try {
        const res = await axios.post(`${Config.base_url}api/UpdatePaymentGatewayKey`, data, {
            // data: {},
        })
...
export async function UPDATE_PAYMENT_AMOUNT(data, token) {
    try {
        const res = await axios.post(`${Config.base_url}api/UpdatePaymentAmount`, data, {
            // data: {},
        })
...
// ALL SERVICES
export async function GetPaymentDetails(data, token) {
    try {
        const res = await axios.post(`${Config.base_url}api/UserPaymentDetails`, data, {
            //  headers: header(token),
            data: {},
        })
