...
export async function user_create_order(data, token) {
    try {
        const res = await axios.post(`${Config.base_url}api/create-order`, data, {
            // headers: header(token),
            data: {},
        })
        return await res?.data;
...
export async function user_create_order1(data, token) {
    try {
        const res = await axios.post(`${Config.base_url}api/order/plan`, data, {
            // headers: header(token),
            data: {},
        })
        return await res?.data;
...
export async function user_update_order(data, token) {
    try {
        const res = await axios.post(`${Config.base_url}api/update-order`, data, {
            // headers: header(token),
            data: {},
        })
        return await res?.data;
...
export async function Get_update_plan1(data, token) {
    try {
        const res = await axios.post(`${Config.base_url}api/update/plan`, data, {
            // headers: header(token),
            data: {},
        })
        return await res?.data;
...
// USER STRATEGY_DESCRIPTION1
export async function STRATEGY_DESCRIPTION1(data, token) {
    try {
        const res = await axios.post(`${Config.base_url}getall/strategy1`, data, {
            headers: header(token),
            data: {},
        })
        return await res?.data;
