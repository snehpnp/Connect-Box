      ...
      if (client_key != undefined) {
        ...
        if (prifix_key_array.includes(FIRST3_KEY)) {
          ...
          if (client_key_array.includes(client_key)) {
            ...
            try {
              const mandotsecuritiesCollection = db1.collection(
              ...
              fs.appendFile(
                ...
                "TIME " +
                  new Date() +
                  " mandotsecurities ALL CLIENT LENGTH " +
                  mandotsecuritiesdocuments.length +
                  "\n",
                function (err) {
                  if (err) {
                    return console.log("Error", err);
              ...
              if (mandotsecuritiesdocuments.length > 0) {
                mandotsecurities.place_order(
                  mandotsecuritiesdocuments,
                  signals,
                  token,
                  filePath,
                  signal_req
            ...
            try {
              ...
              fs.appendFile(
                ...
                "TIME " +
                  new Date() +
                  " mandotsecurities TRADING VIEW CLIENT LENGTH " +
                  mandotsecuritiesdocuments.length +
                  "\n",
                function (err) {
                  if (err) {
          ...
          return res.send({
            status: false,
            msg: "This prefix key does not have a subadmin",
          });
        }
