...
const DynamicForm = ({ fields, ProfileShow, page_title, btn_name1, initialValues, validationSchema, onSubmit, btn_name_signUp, btn_name_login, fromDate, fieldtype, formik, btn_name, forlogin, title, additional_field }) => {
              ...
              <div>
                ...
                <div className="row d-flex " >
                  ...
                  <div className="add-customer-btns text-end mt-3">
                    {btn_name1 ? <a className="btn customer-btn-cancel">
                      {btn_name1}
                    </a> : ""}

                    {btn_name ? <a className="btn customer-btn-save">
                      {btn_name}
                    </a> : ""}
