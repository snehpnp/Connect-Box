...
console.log(errors)
  ...
  const fields = [
...

    {
      ...
      type: "select",
      options:
        getOneUsers.getClients && getOneUsers.getClients[0].license_type == 1
          ? [
              { label: "Demo", value: "1" },
          ...
          : getOneUsers.getClients &&
            getOneUsers.getClients[0].license_type == 0
          ? [
              { label: "2 Day Live", value: "0" },
              { label: "Live", value: "2" },
            ]
...

    {
      ...
      disable:
        getOneUsers.getClients !== undefined &&
        getOneUsers.getClients[0].license_type == 2
          ? true
          : false,
    },
    {
      ...
      .then((response) => {
        if (response.status) {
          ...
          setSelectedCheckboxes(
            response.data.ClientStrategy.map((stg) => stg.strategy_id)
          );
          setSelectedCheckboxesAndPlan(
            response.data.ClientStrategy.map((stg) => ({
              id: stg.strategy_id,
              plan_id: stg.plan_id,
            }))
          );
  ...
  useEffect(() => {
    formik.setFieldValue(
      "fullName",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].FullName
    );
    formik.setFieldValue(
      "username",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].UserName
    );
    formik.setFieldValue(
      "email",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].Email
    );
    formik.setFieldValue(
      "phone",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].PhoneNo
    );
    formik.setFieldValue(
      "broker",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].broker
    );
    formik.setFieldValue(
      "licence",
      getOneUsers.getClients !== undefined &&
        getOneUsers.getClients[0].license_type
    );
    formik.setFieldValue(
      "groupservice",
      getOneUsers.getClients !== undefined &&
        getOneUsers.ClientGroupName[0].groupService_id
    );
    formik.setFieldValue(
      "Service_Type",
      getOneUsers.getClients !== undefined &&
        getOneUsers.getClients[0].Service_Type
    );
    formik.setFieldValue(
      "per_trade_value",
      getOneUsers.getClients !== undefined &&
        getOneUsers.getClients[0].per_trade_value
    );
    formik.setFieldValue(
      "balance",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].Balance
    );
    formik.setFieldValue(
      "demat_userid",
      getOneUsers.getClients !== undefined &&
        getOneUsers.getClients[0].demat_userid
    );
    formik.setFieldValue(
      "api_key",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].api_key
    );

    formik.setFieldValue(
      "app_key",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].app_key
    );
    formik.setFieldValue(
      "api_type",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].api_type
    );
    formik.setFieldValue(
      "client_code",
      getOneUsers.getClients !== undefined &&
        getOneUsers.getClients[0].client_code
    );
    formik.setFieldValue(
      "app_id",
      getOneUsers.getClients !== undefined && getOneUsers.getClients[0].app_id
    );
    formik.setFieldValue(
      "api_secret",
      getOneUsers.getClients !== undefined &&
        getOneUsers.getClients[0].api_secret
    );
    formik.setFieldValue(
      "plan",
      getOneUsers.getClients !== undefined &&
        getOneUsers.getClients[0].plan_id
    );
    formik.setFieldValue(
      "Employees",
      getOneUsers.getClients !== undefined &&
        getOneUsers.getClients[0].employee_id
    );
  }, [getOneUsers.getClients]);
                            ...
                            <div className="col-lg-12">
                              <div className="form-check custom-checkbox ">
                                <input
                                  ...
                                  disabled={
                                    stgDiseble &&
                                    stgDiseble.includes(strategy._id)
                                  }
                                />
                                <label
                                          ...
                                          <div className="form-group d-flex justify-content-between m-3 border rounded p-2 ">
                                            <div className="d-flex align-items-center">
                                              <input
                                                ...
                                                id={`${strategy._id}_1`}
                                                checked={
                                                  selectedCheckboxesAndPlan &&
                                                  selectedCheckboxesAndPlan.some(
                                                    (item) =>
                                                      item.id ===
                                                        strategy._id &&
                                                      item.plan_id == 1
