...
const EditClient = () => {
  ...
  useEffect(()=>{
    formik.setFieldValue("fullName", rowData && rowData.FullName)
    formik.setFieldValue("username", rowData && rowData.UserName)
    formik.setFieldValue("email", rowData && rowData.Email)
    formik.setFieldValue("phone", rowData && rowData.PhoneNo)
    formik.setFieldValue("licence", rowData && rowData.license_type)
    formik.setFieldValue("Service_Type", rowData && rowData.Service_Type)
    formik.setFieldValue("broker", rowData && rowData.broker)
    formik.setFieldValue("demat_userid", rowData && rowData.demat_userid)
    formik.setFieldValue("group_service", rowData && rowData.groupservice)
    formik.setFieldValue("fullName", rowData && rowData.FullName)
    formik.setFieldValue("fullName", rowData && rowData.FullName)
