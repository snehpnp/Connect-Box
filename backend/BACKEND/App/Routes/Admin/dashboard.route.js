...
const { AdminDashboard ,subAdminDashboard,add_broker_information,getall_broker_information,update_broker_information,get_broker_information} = require('../../Controllers/Admin/dashboard.controller')


router.post('/get/dashboard/count', AdminDashboard)
router.post('/get/sub/dashboard', subAdminDashboard)
