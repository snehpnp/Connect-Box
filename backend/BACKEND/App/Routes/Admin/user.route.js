...
const { AddStragegy, GetOneStragegy, EditStragegy, GetAllStrategy,GetAllStrategy1, DeleteStragegy, GetAllStrategyForClient, ClientsAccordingToStrategy } = require('../../Controllers/Admin/strategy.controller')
...
router.post('/getall/strategy1', GetAllStrategy1);
