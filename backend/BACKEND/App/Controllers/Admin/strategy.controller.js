...
class strategy {
    ...
    async GetAllStrategy(req, res) {
        try {
           ...
           // console.log("GetAllClientStrategy",getAllstrategy)
    ...
    async GetAllStrategy1(req, res) {
        try {
            ...
            getAllstrategy.map((data) => {
                New_stg_array.push({
                    _id: data._id,
                    strategy_name: data.strategy_name,
                    strategy_amount: data.strategy_amount,
                    plans1: [
                        { id: 1, type: "month", price: data.strategy_amount_month, status: data.strategy_amount_month != "" || null ? true : false },
                        { id: 2, type: "quarterly", price: data.strategy_amount_quarterly, status: data.strategy_amount_quarterly != "" || null ? true : false },
                        { id: 3, type: "half yearly", price: data.strategy_amount_half_early, status: data.strategy_amount_half_early != "" || null ? true : false },
                        { id: 4, type: "yearly", price: data.strategy_amount_early, status: data.strategy_amount_early != "" || null ? true : false }],
                    strategy_description: data.strategy_description,
                    strategy_category: data.strategy_category,
                    strategy_segment: data.strategy_segment,
                    strategy_indicator: data.strategy_indicator,
                    strategy_tester: data.strategy_tester,
