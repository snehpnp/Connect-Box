...
const Alice_Socket = async () => {
  ...
  var socket = null;
  var broker_infor = await live_price_token.find({
    broker_id: "2",
    trading_status: "on",
  });
  ...
  if (
    broker_infor[0].user_id !== undefined &&
    broker_infor[0].access_token !== undefined &&
    broker_infor[0].trading_status == "on"
  ) {
    try {
              ...
              socket.onmessage = async function (msg) {
                ...
                if (response.tk) {
                  ...
                  const minutes = currentDate
                    ...
                    .toString()
                    .padStart(2, "0");
                  const stock_live_price =
                    db_main.collection("stock_live_price");
